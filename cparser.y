...
enumerator
	: IDENTIFIER { zs_register_symbol(zc_parsectx, zs_file, zs_line, (const char *) $1, ZT_DEFINE, 1); }
	| IDENTIFIER { zs_register_symbol(zc_parsectx, zs_file, zs_line, (const char *) $1, ZT_DEFINE, 1); } '=' constant_expression
	;
...
labeled_statement
	: IDENTIFIER { zs_register_symbol(zc_parsectx, zs_file, zs_line, (const char *) $1, ZT_VARIABLE, 0); } ':' statement
...
jump_statement
	: GOTO IDENTIFIER { zs_register_symbol(zc_parsectx, zs_file, zs_line, (const char *) $1, ZT_DEFINE, 1); } ';'
	| CONTINUE ';'
	| BREAK ';'
	| RETURN ';'
	| RETURN expression ';'
